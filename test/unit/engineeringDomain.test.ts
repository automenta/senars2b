...
describe('Engineering Design Domain Tests', () => {
  ...
  it('should handle system design trade-offs and optimization', () => {
    ...
    core.addInitialBelief(
      'Material A has tensile strength of 500 MPa but costs $10/kg',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialBelief(
      'Material B has tensile strength of 400 MPa but costs $5/kg',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'materials_engineering',
    ...
    core.addInitialGoal(
      'Select optimal material for structural component',
      attention,
      createCognitiveMetadata({
  ...
  it('should handle failure analysis and reliability engineering', () => {
    ...
    core.addInitialBelief(
      'Component X has mean time between failures of 10,000 hours',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialBelief(
      'Operating temperature above 80°C reduces component life by 30%',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialGoal(
      'Design thermal management system for Component X',
      attention,
      createCognitiveMetadata({
        domain: 'thermal_engineering',
