...
describe('Scientific Research Domain Tests', () => {
  ...
  it('should handle scientific hypothesis generation and testing', async () => {
    ...
    await core.addInitialBelief(
      'Increased CO2 levels correlate with temperature rise',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    await core.addInitialBelief(
      'Solar radiation has cycles that affect climate',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'astrophysics',
    ...
    await core.addInitialGoal(
      'Formulate hypothesis about climate change drivers',
      attention,
      createCognitiveMetadata({
        domain: 'climate_science',
        source: 'researcher',
  ...
  it('should handle experimental design scenarios', async () => {
    ...
    await core.addInitialBelief(
      'Drug A shows 70% efficacy in vitro',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'pharmacology',
    ...
    await core.addInitialBelief(
      'Drug A has toxicity concerns in animal models',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'toxicology',
    ...
    await core.addInitialGoal(
      'Design clinical trial protocol for Drug A',
      attention,
      createCognitiveMetadata({
