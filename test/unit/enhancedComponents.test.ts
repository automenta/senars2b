...
describe('Enhanced Components Integration Tests', () => {
  ...
  it('should work with standard components and process multi-domain knowledge', () => {
    ...
    core.addInitialBelief(
      'Machine learning algorithm achieves 95% accuracy',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialBelief(
      'Drug compound shows promising results in trials',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'pharmacology',
  ...
  it('should handle cross-domain reasoning scenarios', () => {
    ...
    core.addInitialBelief(
      'Economic indicator shows positive trend',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'economics',
    ...
    core.addInitialGoal(
      'Analyze market conditions for investment strategy',
      attention,
      createCognitiveMetadata({
        domain: 'finance',
  ...
  it('should support analogical reasoning across domains', () => {
    ...
    core.addInitialBelief(
      'Human brains learn through synaptic plasticity',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'neuroscience',
    ...
    core.addInitialGoal(
      'Apply insights from biological learning to improve AI algorithms',
      attention,
      createCognitiveMetadata({
