...
describe('Business Strategy Domain Tests', () => {
  ...
  it('should handle market analysis and competitive intelligence', () => {
    ...
    core.addInitialBelief(
      'Competitor X is investing heavily in green technology',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialGoal(
      'Develop sustainable product strategy',
      attention,
      createCognitiveMetadata({
  ...
  it('should handle resource allocation and risk management', () => {
    ...
    core.addInitialBelief(
      'R&D budget has 15% cut for next quarter',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'finance',
    ...
    core.addInitialBelief(
      'Market expansion into Asia shows 25% growth potential',
      truth,
      attention,
      createCognitiveMetadata({
