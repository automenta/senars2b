...
import {
  CognitiveCoreConfig,
  CognitiveCoreDependencies,
  DecentralizedCognitiveCore,
} from '@/core/cognitiveCore';
 ...
 */
export function createCognitiveItem(
...
export function createCoreWithRealDependencies(
 ...
 */
export function createAttentionValue(
  overrides: Partial<AttentionValue> = {}
): AttentionValue {
  return {
    priority: 0.5,
    durability: 0.7,
...
export function createMockSchema(
  overrides: Partial<CognitiveSchema> = {}
): CognitiveSchema {
  return {
    atom_id: uuidv4(),
    apply: jest.fn(),
 ...
 */
export function createSemanticAtom(
  overrides: Partial<SemanticAtom> = {}
): SemanticAtom {
  return {
    id: uuidv4(),
 ...
 */
export function createCognitiveMetadata(
