...
describe('Cross-Domain Reasoning Tests', () => {
  ...
  it('should transfer knowledge from epidemiology to cybersecurity', () => {
    ...
    core.addInitialBelief(
      'Virus spread can be contained through contact tracing and isolation',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'epidemiology',
    ...
    core.addInitialBelief(
      'Network attacks spread through vulnerable nodes and lateral movement',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialGoal(
      'Apply epidemiological containment strategies to network security',
      attention,
      createCognitiveMetadata({
        domain: 'cybersecurity',
  ...
  it('should apply engineering reliability principles to organizational management', () => {
    ...
    core.addInitialBelief(
      'Redundancy in engineering systems improves overall reliability',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialBelief(
      'Cross-training employees improves organizational resilience',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialGoal(
      'Design resilient organization using engineering reliability principles',
      attention,
      createCognitiveMetadata({
  ...
  it('should use economic optimization for resource-constrained AI development', () => {
    ...
    core.addInitialBelief(
      'Portfolio theory optimizes return vs. risk in financial investments',
      truth,
      attention,
      createCognitiveMetadata({
        domain: 'finance',
    ...
    core.addInitialBelief(
      'AI model development requires balancing accuracy, computational cost, and energy consumption',
      truth,
      attention,
      createCognitiveMetadata({
    ...
    core.addInitialGoal(
      'Apply portfolio optimization to AI model selection under resource constraints',
      attention,
      createCognitiveMetadata({
        domain: 'ai_systems',
