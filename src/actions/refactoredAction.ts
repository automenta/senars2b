...
export class WebSearchExecutor extends BaseExecutor implements Executor {
    constructor() {
        super('WebSearchExecutor');
    }

    can_execute(goal: CognitiveItem): boolean {
        return this.canExecute(goal);
    }
...
export class AtomicTaskExecutor extends BaseExecutor implements Executor {
    private taskManager: TaskManager;

    constructor(taskManager: TaskManager) {
        super('AtomicTaskExecutor');
...
export class DiagnosticExecutor extends BaseExecutor implements Executor {
    constructor() {
        super('DiagnosticExecutor');
    }
...
export class KnowledgeBaseQueryExecutor extends BaseExecutor implements Executor {
    constructor() {
        super('KnowledgeBaseQueryExecutor');
    }
...
export class PlanningExecutor extends BaseExecutor implements Executor {
    constructor() {
        super('PlanningExecutor');
    }
