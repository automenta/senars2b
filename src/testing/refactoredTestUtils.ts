...
import { isTask, isBelief, isGoal } from '@/utils/typeGuards';
...
export function createCognitiveItem(overrides: Partial<CognitiveItem> = {}): CognitiveItem {
  ...
  const item: CognitiveItem = {
    ...
    stamp: { timestamp: now, parent_ids: [], schema_id: uuidv4() },
    created_at: now,
    updated_at: now,
    ...overrides
  };
...
// Re-export type guards for convenience in tests
export { isTask, isBelief, isGoal } from '@/utils/typeGuards';