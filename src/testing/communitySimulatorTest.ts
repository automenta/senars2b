  ...
  try {
    ...
    const problems = {
      medical: {
        ...
        description:
          'Collaboratively diagnose a complex medical case using probabilistic reasoning',
        problem:
          'A 65-year-old female presents with chest pain, shortness of breath, and fatigue. She has a history of diabetes and hypertension. Her ECG shows ST-segment elevation. Collaborate to determine the most likely diagnosis and treatment plan.',
        category: 'Healthcare',
        difficulty: 'Advanced',
        skills: [
          'Medical Knowledge',
      ...
      environmental: {
        ...
        description:
          'Evaluate the environmental impact of a proposed industrial project',
        problem:
          'A company plans to build a chemical plant near a river that supplies water to several communities. Assess the potential environmental impact and propose mitigation strategies.',
