...
import { TruthValue, AttentionValue, SemanticAtom, CognitiveItem } from '../interfaces/types';

function runBasicComponentTests() {
    ...
    const initialAttention = attentionModule.calculate_initial(item1);
