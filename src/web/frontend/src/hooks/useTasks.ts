...
export const useTasks = () => {
  const { tasks, searchTerm, statusFilter, typeFilter, sortOption } =
    useStore();
      ...
      return tasks
        ...
        .sort((a, b) => {
          switch (sortOption) {
            case 'priority-desc':
              return (
                priorityOrder[b.priority.toLowerCase() as TaskPriority] -
                priorityOrder[a.priority.toLowerCase() as TaskPriority]
              );
            case 'priority-asc':
              return (
                priorityOrder[a.priority.toLowerCase() as TaskPriority] -
