...
const TaskList: React.FC<TaskListProps> = memo(
  ({ tasks, sendMessage, isSublist = false, selectedTaskIndex = -1 }) => {
    ...
    const { selectedIndex, selectItem, selectFirst, selectLast } =
    ...
    const renderTaskItem = useCallback(
      (task: Task, index: number) => (
        <div
          ...
          draggable={isSublist}
          onDragStart={
            isSublist ? (e) => handleDragStart(e, task.id) : undefined
          }
