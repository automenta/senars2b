...
import { FaChevronDown, FaChevronRight, FaStream, FaSave, FaGripVertical } from 'react-icons/fa';
...
const TaskItem: React.FC<TaskItemProps> = ({ task, allFilteredTasks, sendMessage, isDraggable = false, isSelected = false }) => {
    ...
    >
      <div className={itemClassName}>
        ...
        <div className={styles.controlsContainer}>
          {isEditing ? (
            <button onClick={handleSave} className={`${styles.button} ${styles.saveBtn}`} title="Save" aria-label="Save changes">
              <FaSave />
            </button>
          ) : (
