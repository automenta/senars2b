...
export class UnifiedTaskManager extends BaseManager implements TaskManager {
    ...
    updateTask(id: string, updates: Partial<CognitiveItem>): CognitiveItem | null {
        ...
        this.statisticsTracker.increment('tasksUpdated');
        return task;
    }
    ...
    removeTask(id: string): boolean {
        ...
        if (removedFromWorldModel) {
            ...
            this.statisticsTracker.increment('tasksRemoved');
        }
    ...
    updateTaskStatus(id: string, status: TaskStatus): CognitiveItem | null {
        ...
        this.statisticsTracker.increment('taskStatusChanges');
    ...
    updateItem(id: string, updates: Partial<CognitiveItem>): CognitiveItem | null {
    ...
    private _createAndStoreTask(
        ...
        this.statisticsTracker.increment('tasksCreated');
        return task;
    }

    protected notifyListeners(event: { type: string; task: CognitiveItem }): void {
