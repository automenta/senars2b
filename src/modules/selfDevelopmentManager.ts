...
import { TestAnalysisModule, TestResult, CoverageData } from './testAnalysisModule';
import { SelfRepresentationModule } from './selfRepresentationModule';
import { EnhancementProposalModule, EnhancementProposal } from './enhancementProposalModule';
...
export class SelfDevelopmentManager {
  ...
  private webSocketInterface: WebSocketInterface | null = null;
